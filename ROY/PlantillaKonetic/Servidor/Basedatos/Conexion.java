...
public class Conexion {
    ...
    private String database = DatosAplicacion.nombreAplicacion.toLowerCase();
    ...
    public Conexion() throws OnExceptionBD {
       // synchronized (this) {
            try {
                ConexionString ConexionString = new ConexionString();
                username = ConexionString.getUsername();
                password = ConexionString.getPassword();
