...
////////////////////////Buscar////////////////////////////////////////////
    validarFormulario("#frmBuscarTarea", urlServlet);
    //boton de crear
    $("#buttonCrearTarea").click(function (e) {
        e.preventDefault();
        window.location.href = "CrearTarea.jsp";
    });
    //
...
function validarFormulario(nombreForm, urlServlet) {
    ...
    $(nombreForm).validate({
        ...
        messages: {
            ...
            id: {
                required: "Debe introducir el id de su Tarea."
            },
            nombre: {
                required: "Debe introducir el nombre de su Tarea."
            },
            descripcion: {
                required: "Debe introducir una descripción de Tarea."
            }
