 ...
 */
package Servlet.UsuarioRegistro;

import Basedatos.OnExceptionBD;
import Clases.CrearUsuario.ControladorRegistros2;
 ...
 * @author Angel
 */
public class CrearUsuarioRegistro extends HttpServlet {
            ...
            for (int i = 0; i < items.size(); i++) {
                ...
                if (!item.isFormField()) {
                    ...
                    if (idCampo.equals("nombre")) {
                        nombre = valor;
                    } else if (idCampo.equals("email")) {
                        email = valor;

                    } else if (idCampo.equals("password")) {
                        password = valor;
...
//            System.out.println(Registro.toString());
                ...
                ControladorRegistros2 controlador = new ControladorRegistros2();

                //Mensaje de guardado
                if (controlador.crearRegistroUsuario(Registro)) {

                    ArrayList<String> lista = new ArrayList<String>();
                    lista.add("Has guardado los datos de " + Registro.getNombre() + " correctamente.");
                    Gson gson = new Gson();
