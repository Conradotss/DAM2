 ...
 * @author OnAngel
 */
public class Encontrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<Consumo> lista = controlador.buscarConsumo2();
            ArrayList<Consumo> checkboxStatus = controlador.getCheckboxStatusForUser(id);
            ...
            for (int i = 1; i < DatosConsumo.nombreTitulosCabeceraTabla2.length; i++) {
                htmlcode += "<th>";
                htmlcode += DatosConsumo.nombreTitulosCabeceraTabla2[i];
                htmlcode += "</th>";
            }
            ...
            for (int i = 0; i < lista.size(); i++) {
                ...
                boolean isChecked = checkboxStatus.stream().anyMatch(checkbox -> checkbox.getA() == Consumo.getA());
