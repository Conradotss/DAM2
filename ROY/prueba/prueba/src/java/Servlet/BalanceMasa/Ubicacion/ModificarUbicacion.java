 ...
 * @author OnAngel
 */
public class ModificarUbicacion extends HttpServlet {
...
//                System.out.println(item.getString());
                ...
                if (!item.isFormField()) {
//                    String ubicacionArchivo = item.getContentType();
//                    if (ubicacionArchivo.startsWith("image/")) {
//                        /*cual sera la ruta al archivo en el servidor*/
//                        if (crearCarpetasAplicación("Ubicacion" + System.getProperty("file.separator"))) {
//                            String ruta = DatosAplicacion.dirAplicacionCarpetaPadre + "\\Ubicacion\\" + item.getName();
//                            File archivo_server = new File(ruta);
//                            /*y lo escribimos en el servido*/
//                            item.write(archivo_server);
//                            imagen = ruta;
//                            String rutaProyecto = DatosAplicacion.dirAplicacionCarpetaWebapps + "\\Ubicacion\\" + item.getName();
...
//                    System.out.println(idCampo + ": " + valor);
                    if (idCampo.equals("id")) {
                        ubicacion_id = Integer.parseInt(valor);
...
//            System.out.println(Ubicacion.toString());
                ...
                //Mensaje de guardado
                if (controlador.modificarUbicacion(Ubicacion)) {

                    ArrayList<String> lista = new ArrayList<String>();
                    lista.add("Has modificado los datos de " + Ubicacion.getNombre() + " correctamente.");
