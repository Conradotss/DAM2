 ...
 * @author Angel
 */
public class CrearUbicacion extends HttpServlet {
...
//            System.out.println(Ubicacion.toString());
                ...
                //Mensaje de guardado
                if (controlador.crearUbicacion(Ubicacion)) {
                    ArrayList<String> lista = new ArrayList<String>();
                    lista.add("Has guardado los datos de " + Ubicacion.getNombre() + " correctamente.");
                    Gson gson = new Gson();
