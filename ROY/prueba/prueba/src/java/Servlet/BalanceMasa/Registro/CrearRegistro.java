...
//            System.out.println(Registro.toString());
                ...
                //Mensaje de guardado
                if (controlador.crearRegistro(Registro)) {
                    ArrayList<String> lista = new ArrayList<String>();
                    lista.add("Has guardado los datos de " + Registro.getOrdenTrabajoID() + " correctamente.");
                    Gson gson = new Gson();
