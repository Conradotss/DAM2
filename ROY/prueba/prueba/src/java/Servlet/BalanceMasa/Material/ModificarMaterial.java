...
public class ModificarMaterial extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int materialregistroproduccion_id = 0;
            String nombre = "";
            String descripcion = "";
            String referencia = "";
...
//                System.out.println(item.getString());
                ...
                if (!item.isFormField()) {
//                    String materialArchivo = item.getContentType();
//                    if (materialArchivo.startsWith("image/")) {
//                        /*cual sera la ruta al archivo en el servidor*/
//                        if (crearCarpetasAplicación("Materiales" + System.getProperty("file.separator"))) {
//                            String ruta = DatosAplicacion.dirAplicacionCarpetaPadre + "\\Materiales\\" + item.getName();
//                            File archivo_server = new File(ruta);
//                            /*y lo escribimos en el servido*/
//                            item.write(archivo_server);
//                            imagen = ruta;
//                            String rutaProyecto = DatosAplicacion.dirAplicacionCarpetaWebapps + "\\Materiales\\" + item.getName();
...
//                    System.out.println(idCampo + ": " + valor);
                    if (idCampo.equals("id")) {
                        materialregistroproduccion_id = Integer.parseInt(valor);
                    } else if (idCampo.equals("nombre")) {
                        nombre = valor;
                    } else if (idCampo.equals("referencia")) {
                        referencia = valor;
...
//            System.out.println(Material.toString());
                ...
                //Mensaje de guardado
                if (controlador.modificarMaterial(Material)) {

                    ArrayList<String> lista = new ArrayList<String>();
                    lista.add("Has modificado los datos de " + Material.getNombre() + " correctamente.");
