...
//            System.out.println(Tarea.toString());
                ...
                //Mensaje de guardado
                if (controlador.crearTarea(Tarea)) { //guardar usuario en la BD
                    
                    ArrayList<String> lista = new ArrayList<String>(); //crear array dinamico de string
                    lista.add("Has guardado los datos de " + Tarea.getNombre() + " correctamente."); //mensaje creacion completada
                    
                    Gson gson = new Gson(); //crear objeto de tipo GSON
                    String toJson = gson.toJson(lista, ArrayList.class); //se convierte de arraylist a json 
                    response.getWriter().println(toJson); //la cadena JSON generada se escribe en la respuesta HTTP
                }
