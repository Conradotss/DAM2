...
(function(L) {
    ...
    L.jqplot.config = {
        ...
        enablePlugins: false,
        defaultHeight: 600,
        defaultWidth: screen.width / 2 - ((screen.width / 2) * 0.02),
        UTCAdjust: false,
        ...
        defaultColors: ["#D78508", "#D9A453", "#09DBB7", "#64E1CB", "#839557", "#958c12", "#953579", "#4b5de4", "#d8b83f", "#ff5800", "#0085cc", "#c747a3", "#cddf54", "#FBD178", "#26B4E3", "#bd70c7"],
