            ...
            d = {
                ...
                addArea: function (b, d) {
                    1 == arguments.length && (d = b, b = a(this).data("imageMapper")), c[b].area[c[b].state.areaLength] = {
                        ...
                        title: "pepe el de los huevos repe",
                        target: "_blank",
                        coords: []
                ...
                asHTML: function (b) {
                    var d = a("<img />"),
                            e = c[b].options.src;//Aquí se escribe la ruta de la imagen original
                    d.attr("class", "mapa"); //Damos clase
                    ...
                    a.each(c[b].area, function (d, e) {
                        ...
                        var i = a("<area />");
                        i.attr("class", "punteroImgMap"), //Damos clase a puntero
        ...
        function (a) {
            a(document).on("init", function () {
                ...
                a(document).on("click", "button.add-row", function (b) {
                    ...
                    //var code = $("#modal-code-result").val();
                    //alert(code);
