...
////////////////////////Buscar////////////////////////////////////////////
    validarFormulario("#frmBuscarUsuario", urlServlet);
    //boton de crear
    $("#buttonCrearUsuario").click(function (e) {
        e.preventDefault();
...
function validarFormulario(nombreForm, urlServlet) {
    ...
    $(nombreForm).validate({
        ...
        messages: {
            ...
            id: {
                required: "Debe introducir el id de su Usuario."
            },
            nombre: {
                required: "Debe introducir el nombre de su Usuario."
            },
            descripcion: {
                required: "Debe introducir una descripción de Usuario."
            }
