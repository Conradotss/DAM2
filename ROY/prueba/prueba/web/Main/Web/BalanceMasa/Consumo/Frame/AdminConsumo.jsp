...
<html>
    <head>
        ...
        <title>Admin - Consumos</title>        
        <%=DatosAplicacion.importjs%>

        <!--Para éste jsp **************************************************************-->
        <script type="text/javascript" src="../js/BusquedaConsumo.js"></script> 
        <script type="text/javascript" src="../js/AdminConsumo.js"></script> 
    ...
    <body class="bg-white" >
        ...
        <div class="form-basic">
            <div class="form-title-row">
                <h1>Admin - Consumos</h1>
            </div>

            <div class="divBusqueda">
                <jsp:include page="../Form/BusquedaConsumo.jsp"></jsp:include>
            </div>
